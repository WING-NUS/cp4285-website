...
| 3 | Project / Group Project | 30% | Group project with critique session, implementation, evaluation, and one final deliverable: a STePS presentation or a report. |
...
You should already be familiar with the University's [NUS Code of Student Conduct](https://studentconduct.nus.edu.sg/wp-content/uploads/NUS-Code-of-Student-Conduct.pdf) (Office of Student Conduct, NUS). If you haven't yet, read it now.
...
This course follows the [NUS Policy for Use of AI in Teaching and Learning](https://ctlt.nus.edu.sg/policy-for-use-of-ai-in-teaching-and-learning.pdf) (NUS Centre for Teaching, Learning and Technology, 2024). The course-specific application of that policy is as follows:
