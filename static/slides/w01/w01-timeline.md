...
| `Project (30%)` | 7 min | 59 min | Instructor | Explain that students may form 2–4-person teams, but Min has final authority and may override groups for diversity. Cover the declaration due Mon, 24 Aug 2026, 23:59 SGT, the Week 07 design critique, and the Wed, 11 Nov final presentation. |
| `Quizzes` | 4 min | 63 min | Instructor | Explain the peer-and-instructor co-creation workflow, including random assignment of peers to a week and section and instructor curation of final questions. |
