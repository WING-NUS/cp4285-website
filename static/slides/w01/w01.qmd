...
<div aria-labelledby="w01-changelog-title" style="margin:1.2em auto 0;max-width:72%;padding:.55em .8em;border-left:3px solid #003D7C;border-radius:0 6px 6px 0;background:rgba(255,255,255,.78);color:#003D7C;font-family:Arial,Helvetica,sans-serif;font-size:.42em;line-height:1.35;">
  ...
  <ul style="margin:0;padding-left:1.2em;">
    <li><strong style="color:#EF7C00;">5 Sep 2026</strong> — Standardised week labels and deadline date-time formatting; resized the dataset-catalogue screenshot to fit the slide.</li>
    <li><strong style="color:#EF7C00;">20 Aug 2026</strong> — Standardised slide primitives and timers; clarified worked examples, colour mapping, and notation.</li>
    <li><strong class="cp-text--navy">10 Aug 2026</strong> — Refined activities, modelling prompts, and the neighbourhood-CF teaching sequence.</li>
  </ul>
</div>
```
...
| Group Project | 30% |
| In-Class Quizzes| 10% |
| Final Exam (<span class="cp-text--teal">Mon, 23 Nov 2026 · 13:00–15:00 SGT</span>) | 30% |
...
<div style="height:68vh;display:flex;flex-direction:column;align-items:center;justify-content:center;">
  <a href="https://github.com/RUCAIBox/RecSysDatasets" target="_blank" rel="noopener" style="display:flex;align-items:center;justify-content:center;width:100%;max-height:51vh;">
    <img src="../../uploads/recsysdatasets-github.png" alt="Screenshot of the RUCAIBox RecSysDatasets GitHub repository, a public catalogue of recommender-system data sources." style="display:block;width:auto;max-width:min(1120px,88vw);height:auto;max-height:50vh;object-fit:contain;border:4px solid #003D7C;border-radius:8px;box-shadow:0 8px 22px rgba(0,0,0,.2);">
  </a>
...
Unless a slide or Canvas announcement specifies otherwise, assignment deadlines are on <strong class="cp-text--teal">Mon, 23:59 SGT</strong>.
...
<table style="width:100%;border-collapse:collapse;text-align:center;">
  ...
  <tbody>
    <tr><th style="padding:.24em;text-align:left;"><i>u</i><sub>1</sub> (<i>u</i>)</th><td class="cp-divider--red">5</td><td>?</td><td class="cp-divider--red">2</td><td class="cp-divider--red">4</td><td>?</td></tr>
    <tr><th style="padding:.24em;text-align:left;"><i>u</i><sub>6</sub> (<i>v</i>)</th><td class="cp-divider--red" style="border-bottom:3px solid #D32F2F;">5</td><td>4</td><td class="cp-divider--red" style="border-bottom:3px solid #D32F2F;">5</td><td class="cp-divider--red" style="border-bottom:3px solid #D32F2F;">2</td><td>4</td></tr>
  </tbody>
</table>
```
...
### User–user example: <span style="color:#00796B;">$u_1$</span> and <span style="color:#A24B00;">$u_6$</span>
...
<table style="width:100%;border-collapse:collapse;text-align:center;">
  ...
  <tbody>
    <tr style="color:#00796B;font-weight:700;"><th style="padding:.24em;text-align:left;"><i>u</i><sub>1</sub></th><td class="cp-divider--red">5</td><td>?</td><td class="cp-divider--red">2</td><td class="cp-divider--red">4</td><td>?</td></tr>
    <tr style="color:#A24B00;font-weight:700;"><th style="padding:.24em;text-align:left;"><i>u</i><sub>6</sub></th><td class="cp-divider--red" style="border-bottom:3px solid #D32F2F;color:#EF7C00;">5</td><td style="color:#EF7C00;">4</td><td class="cp-divider--red" style="border-bottom:3px solid #D32F2F;color:#EF7C00;">5</td><td class="cp-divider--red" style="border-bottom:3px solid #D32F2F;color:#EF7C00;">2</td><td style="color:#EF7C00;">4</td></tr>
  </tbody>
</table>
```
:::
...
$$\mu_{\color{teal}{1}}=\color{teal}{\frac{11}{3}},\quad \mu_{\color{orange}{6}}=\color{orange}{4}$$
$$\mathbf s_{\color{teal}{1}}=\color{teal}{\left(\frac{4}{3},-\frac{5}{3},\frac{1}{3}\right)},\quad \mathbf s_{\color{orange}{6}}=\color{orange}{(1,1,-2)}$$
:::
...
### <span style="color:#00796B;">$u_1$</span> and <span style="color:#A24B00;">$u_6$</span>
...
<table style="width:100%;border-collapse:collapse;text-align:center;">
  ...
  <tbody>
    <tr style="color:#00796B;font-weight:700;"><th style="padding:.24em;text-align:left;"><i>u</i><sub>1</sub></th><td class="cp-divider--red">5</td><td>?</td><td class="cp-divider--red">2</td><td class="cp-divider--red">4</td><td>?</td></tr>
    <tr style="color:#EF7C00;font-weight:700;"><th style="padding:.24em;text-align:left;"><i>u</i><sub>6</sub></th><td class="cp-divider--red" style="border-bottom:3px solid #D32F2F;color:#EF7C00;">5</td><td style="color:#EF7C00;">4</td><td class="cp-divider--red" style="border-bottom:3px solid #D32F2F;color:#EF7C00;">5</td><td class="cp-divider--red" style="border-bottom:3px solid #D32F2F;color:#EF7C00;">2</td><td style="color:#EF7C00;">4</td></tr>
  </tbody>
</table>
```
...
### Items <span style="color:#00796B;">$i_1$</span> and <span style="color:#A24B00;">$i_5$</span> after user mean-centring
...
<table style="width:100%;border-collapse:collapse;text-align:center;font-size:.72em;line-height:1.12;">
  <thead style="background:#003D7C;color:#fff;"><tr><th style="padding:.28em;"><i>R</i></th><th style="padding:.28em;border:3px solid #D32F2F;color:#80CBC4;"><i>i</i><sub>1</sub></th><th style="padding:.28em;"><i>i</i><sub>2</sub></th><th style="padding:.28em;"><i>i</i><sub>3</sub></th><th style="padding:.28em;"><i>i</i><sub>4</sub></th><th style="padding:.28em;border:3px solid #D32F2F;color:#FFCC80;"><i>i</i><sub>5</sub></th></tr></thead>
  <tbody>
    <tr><th style="padding:.24em;text-align:left;"><i>u</i><sub>1</sub></th><td class="cp-divider--red" style="color:#00796B;font-weight:700;">5</td><td>?</td><td>2</td><td>4</td><td class="cp-divider--red" style="color:#A24B00;font-weight:700;">?</td></tr>
    <tr><th style="padding:.24em;text-align:left;"><i>u</i><sub>2</sub></th><td class="cp-divider--red" style="color:#00796B;font-weight:700;">?</td><td>4</td><td>?</td><td>1</td><td class="cp-divider--red" style="color:#A24B00;font-weight:700;">3</td></tr>
    <tr><th style="padding:.24em;text-align:left;"><i>u</i><sub>3</sub></th><td class="cp-divider--red" style="color:#00796B;font-weight:700;">?</td><td>?</td><td>?</td><td>?</td><td class="cp-divider--red" style="color:#A24B00;font-weight:700;">?</td></tr>
    <tr><th style="padding:.24em;text-align:left;"><i>u</i><sub>4</sub></th><td class="cp-divider--red" style="color:#00796B;font-weight:700;">3</td><td>?</td><td>4</td><td>?</td><td class="cp-divider--red" style="color:#A24B00;font-weight:700;">2</td></tr>
    <tr><th style="padding:.24em;text-align:left;"><i>u</i><sub>5</sub></th><td class="cp-divider--red" style="color:#00796B;font-weight:700;">?</td><td>2</td><td>?</td><td>5</td><td class="cp-divider--red" style="color:#A24B00;font-weight:700;">?</td></tr>
    <tr><th style="padding:.24em;text-align:left;"><i>u</i><sub>6</sub></th><td class="cp-divider--red" style="color:#00796B;font-weight:700;">5</td><td>4</td><td>5</td><td>2</td><td class="cp-divider--red" style="color:#A24B00;font-weight:700;">4</td></tr>
    <tr><th style="padding:.24em;text-align:left;"><i>u</i><sub>7</sub></th><td class="cp-divider--red" style="color:#00796B;font-weight:700;">5</td><td>1</td><td>5</td><td>1</td><td class="cp-divider--red" style="color:#A24B00;font-weight:700;">5</td></tr>
    <tr><th style="padding:.24em;text-align:left;"><i>u</i><sub>8</sub></th><td style="border:3px solid #D32F2F;border-top:0;color:#00796B;font-weight:700;">?</td><td>?</td><td>4</td><td>?</td><td style="border:3px solid #D32F2F;border-top:0;color:#A24B00;font-weight:700;">?</td></tr>
  </tbody>
</table>
```
...
<div class="cp-frame-content">
  ...
  <div class="cp-frame-body" style="color:#333;font-size:.82em;line-height:1.25;">
    <p style="font-weight:bold;color:#003D7C;margin:0 0 .45em;">Canvas discussion board · post before <span class="cp-text--teal">Mon, 17 Aug 2026 · 23:59 SGT</span></p>
