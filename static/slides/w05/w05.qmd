...
# 02 Session-Based Models {background-color="#EF7C00"}
...
<div class="cp-flow-sequence">
  ...
  <span class="cp-flow-arrow" aria-hidden="true">→</span>
...
```{=html}
<div class="cp-flow-card cp-flow-card--sequence"><strong class="cp-flow-step">item 1</strong><span class="cp-flow-arrow" aria-hidden="true">→</span><span class="cp-flow-step">GRU state</span><span class="cp-flow-arrow" aria-hidden="true">→</span><strong class="cp-flow-step">item 2</strong><span class="cp-flow-arrow" aria-hidden="true">→</span><span class="cp-flow-step">updated GRU state</span><span class="cp-flow-arrow" aria-hidden="true">→</span><strong class="cp-flow-step">score next items</strong></div>
```
...
<div style="display:flex;align-items:center;justify-content:center;width:100%;height:76vh;background:#000;">
  <a href="https://www.youtube.com/watch?v=IBs8D8PWMc8&t=282s" target="_blank" rel="noopener" aria-label="Open video: Gated Recurrent Unit explained in detail">
    <img src="https://img.youtube.com/vi/IBs8D8PWMc8/maxresdefault.jpg" alt="YouTube thumbnail for Gated Recurrent Unit explained in detail" style="display:block;width:100%;max-width:1280px;height:auto;max-height:76vh;object-fit:contain;border:4px solid #EF7C00;">
  </a>
</div>
```

::: notes
Delivery: 2 minutes. Open at 4:42 and play to 6:42 only. Ask: “Which gate would help after a user abruptly shifts from planning museums to finding food delivery?” The clip explains GRUs generally; map the idea to GRU4Rec without treating the video as an authority on recommender systems.
...
# 03 Sequential Recommendation {background-color="#EF7C00"}
