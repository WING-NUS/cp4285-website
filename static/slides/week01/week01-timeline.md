...
| `Find the Recommender` | 3 min | In-class activity | Students audit one recent recommendation, identify likely signals and objective, and name who or what might be left unseen. Use pairs, then take one or two observations. The frame is labelled **👥 In Lecture Activity**. |
