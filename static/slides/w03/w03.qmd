...
<div aria-labelledby="w03-changelog-title" style="margin:1.2em auto 0;max-width:72%;padding:.55em .8em;border-left:3px solid #003D7C;border-radius:0 6px 6px 0;background:rgba(255,255,255,.78);color:#003D7C;font-family:Arial,Helvetica,sans-serif;font-size:.42em;line-height:1.35;">
  ...
  <ul style="margin:0;padding-left:1.2em;">
    <li><strong class="cp-text--teal">25 Aug 2026</strong> — Added the Week 02 Canvas Voices review and guardrail discussion.</li>
    <li><strong class="cp-text--teal">25 Aug 2026</strong> — Added the Week 04 pre-lecture activity and linked preview image.</li>
  </ul>
</div>
```
...
<p style="margin:.05em 0 .62em;color:#A24B00;font-size:.48em;font-weight:700;letter-spacing:.045em;text-transform:uppercase;">Mon, 24 Aug · 23:59 SGT</p>
...
```{=html}
<div role="note" style="margin:.12em .06em .55em;padding:.48em .68em;border-left:5px solid #5C2D91;background:#F4F0FA;color:#40374B;font-size:.55em;line-height:1.24;"><strong style="color:#5C2D91;">AI-use note.</strong>As per the `e1` specification, remember AI should not be used in completing the peer review.</div>
```
...
<div class="cp-activity cp-activity--navy cp-activity--framed cp-grid cp-grid--2-aside">
  ...
  <div class="cp-activity__timer cp-center">
    <div class="cp-timer">
      ...
      <span id="w03-split-status" role="timer" aria-live="polite" class="cp-sr-only">00:30</span>
      <button id="w03-split-btn" type="button" class="cp-timer__button" data-cp-timer data-seconds="30" data-ring="w03-split-ring" data-text="w03-split-text" data-status="w03-split-status">▶ Start Timer</button>
    </div>
  </div>
</div>
```
