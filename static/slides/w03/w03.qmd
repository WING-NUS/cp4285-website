...
<div class="cp-frame-content">
  ...
  <div class="cp-frame-title cp-text--navy">What evidence would make that responsibility visible?</div>
  <div class="cp-frame-body" style="color:#333;display:grid;grid-template-columns:1fr 1fr;gap:1.3em;align-items:stretch;">
    <div class="cp-card cp-card--soft">
      <p class="cp-card__title">Listen for in the discussion</p>
      <ul style="margin:.25em 0 0;padding-left:1.15em;line-height:1.35;">
        <li>the responsibility named beyond engagement;</li>
        <li>the affected situation: ♣, ♥, ♦, or ♠; and</li>
        <li>the evidence, safeguard, or user control proposed.</li>
      </ul>
    </div>
    <div class="cp-card cp-card--prompt">
      <p class="cp-card__title">🎙 Voice agent checkpoint</p>
      <p style="margin:0;">Ask the voice agent: <em>“A platform says clicks prove its feed works for younger users. What question should its evaluation still answer?”</em></p>
      <p class="cp-card__meta">Treat the response as a prompt for critique, not as evidence or a policy authority.</p>
    </div>
  </div>
</div>
```
...
::: notes
Delivery: 2-minute voice-agent interaction. Invite one student to phrase the question, then ask the room to identify the lens and the evidence that would be needed to investigate the agent's concern. Do not treat a voice-agent answer as a factual source; it is a structured counterargument.
:::
