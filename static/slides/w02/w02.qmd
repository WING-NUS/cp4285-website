...
<div class="cp-frame-content">
  ...
  <div class="cp-frame-body" style="color:#333;font-size:.82em;line-height:1.25;">
    <p style="font-weight:bold;color:#003D7C;margin:0 0 .45em;">Canvas discussion board · post before <span class="cp-text--teal">Mon, 24 Aug 23:59 SGT</span></p>
...
<div class="cp-frame-content">
  ...
  <div class="cp-frame-body" style="color:#333;display:grid;grid-template-columns:minmax(270px,.82fr) minmax(0,1.48fr);gap:1em;align-items:stretch;">
    <section aria-label="Assigned reading" style="padding:.46em;border:2px solid #D5DEE9;background:#F8FAFD;">
      ...
      <p><strong>Read:</strong> <a href="https://www.straitstimes.com/singapore/singapore-studying-restrictions-on-direct-messaging-auto-play-on-social-media" target="_blank" rel="noopener">“S’pore studying restrictions on direct messaging, auto-play on social media to protect kids”</a></p>
      <p style="color:#4B5563;">Use one detail about auto-play, direct messaging, or age assurance as evidence in your comment.</p>
    </section>
    <section aria-label="Canvas comment task">
      ...
      <div aria-label="Choose one card-suit lens" style="display:grid;grid-template-columns:1fr 1fr;gap:.32em .55em;margin:.12em 0 .62em;">
        <span style="padding:.30em .36em;border-bottom:1px solid #D5DEE9;color:#4B5563;line-height:1.15;"><b class="cp-text--navy">♣ Robustness</b> · narrow or harmful incentives?</span>
        <span style="padding:.30em .36em;border-bottom:1px solid #D5DEE9;color:#4B5563;line-height:1.15;"><b style="color:#C62828;">♥ Social impact</b> · safety, well-being, or exposure?</span>
        <span style="padding:.30em .36em;border-bottom:1px solid #D5DEE9;color:#4B5563;line-height:1.15;"><b style="color:#C62828;">♦ Discovery</b> · variety or more of the same?</span>
        <span style="padding:.30em .36em;border-bottom:1px solid #D5DEE9;color:#4B5563;line-height:1.15;"><b class="cp-text--navy">♠ Control &amp; explanation</b> · adjust or challenge the feed?</span>
      </div>
...
::: notes
Use the Week 01 Slide 59 treatment directly: white field, navy frame, orange-on-navy label, and the standard shared CP4285 frame typography. The image is a local PNG copy of the article’s lead image so that it can render reliably; credit it as “PHOTO: ST FILE.” Direct students to the linked article and Canvas discussion board. State the deadline clearly. The task is an individual comment only; explicitly state that no reply is required because of the assignment deadline. Remind students to name their selected suit in the first sentence.
...
<div class="cp-frame-content" style="color:white;">
  ...
  <div class="cp-frame-body" style="color:#cce8e5;">
    <section>
      <p style="font-size:1.08em;line-height:1.35;">An offline metric tells us how a list performed. Next, we ask whether the recommendation process performs well under a scenario.</p>
      <p><strong style="color:#ffffff;">In Week 3:</strong></p>
      <ul>
    ...
    <section aria-label="The Week 01 four-suit evaluation lens" style="padding-left:.92em;border-left:5px solid #80cbc4;">
      <p><strong style="color:#80cbc4;">Bring the Week 01 four-suit lens</strong></p>
      <p><b>♣ ♥ ♦ ♠</b></p>
    </section>
  </div>
</div>
